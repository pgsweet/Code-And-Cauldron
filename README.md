...
You're a wizard's apprentice and you need to write assembly code to cast his spells and create potions, given materials such as: a wand, a cauldron, empty bottles, and magical ingredients.
...
This game can be used to help students who are in machine learning or assemebly langauge courses. It can be used as a tool in the classroom or a game students can play outside of school to get a grasp of programming in assembly.
...
- Prior to the game, players need to have basic assembly knowledge of the syntax and how assembly code works
...
In the longer term, every three attempts per level the player will get a hint about what the answer should be. This way they get an idea on where they are messing up and can improve. However, if more than 1 hint is used, the player fails the level and needs to do it again.
